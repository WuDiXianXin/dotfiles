return {
  ...
  config = function()
    ...
    gitsigns.setup({
      ...
      highlight_config = {
        GitSignsAdd = { fg = tokyo_colors.git.add },
        GitSignsChange = { fg = tokyo_colors.git.change },
        GitSignsDelete = { fg = tokyo_colors.git.delete },
        GitSignsTopDelete = { fg = tokyo_colors.git.delete },
        GitSignsChangeDelete = { fg = tokyo_colors.warning },
        GitSignsUntracked = { fg = tokyo_colors.comment },
      },
