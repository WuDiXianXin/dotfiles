...
-- ===================== 核心 LSP 增强（覆盖通用键位） =====================
nmap('gra', function() vim.cmd.RustLsp('codeAction') end, 'Rust: 代码动作（支持分组）')
nmap('K', function() vim.cmd.RustLsp({ 'hover', 'actions' }) end, 'Rust: 悬浮信息 + 动作')

-- ===================== 运行 & 测试 =====================
nmap('<leader>rr', function() vim.cmd.RustLsp('runnables') end, 'Rust: 选择并运行 Runnable')
nmap('<leader>rR', function() vim.cmd.RustLsp({ 'runnables', bang = true }) end, 'Rust: 重跑上一个 Runnable')
...
-- ===================== 诊断 & 错误解释 =====================
nmap('<leader>ee', function() vim.cmd.RustLsp({ 'explainError', 'cycle' }) end, 'Rust: 循环解释错误')
nmap('<leader>rdg', function() vim.cmd.RustLsp('renderDiagnostic') end, 'Rust: 显示当前详细诊断')
nmap('<leader>fc', function() vim.cmd.RustLsp({ 'flyCheck', 'run' }) end, 'Rust: 手动运行 flyCheck (check/clippy)')

-- ===================== 导航 =====================
nmap('<leader>pm', function() vim.cmd.RustLsp('parentModule') end, 'Rust: 跳转到父模块')
